...
`gcc threeHandStand.c -lm -Wall; ./a.out`
...
Compile and run at command line with
`gcc twoHandStand.c -lm -Wall; ./a.out`
or equivalent for your OS.
...
`gcc H17_sim.c -lm -O2 -Wall; ./a.out`
or equivalent with your OS.
...
`gcc S17_sim.c -lm -O2 -Wall; ./a.out`
or equivalent with your OS.
